...
@XmlRootElement(name = "backoutCase")
public class BackoutCase {

    @XmlElementRef(name = "in0", namespace = "http://www.primeton.com/multiTGService", type = JAXBElement.class, required = false)
